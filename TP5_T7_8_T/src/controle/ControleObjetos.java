...
public class ControleObjetos{
	...
	public boolean inserirEditarFuncionario(String[] dadosFuncionario) {
		if((dadosFuncionario[1].matches(".*\\d.*"))  || (dadosFuncionario[1].isEmpty()) ||
				(!dadosFuncionario[2].contains("@")) || (dadosFuncionario[2].isEmpty())	||
				(dadosFuncionario[2].charAt(0)=='@') || (!dadosFuncionario[3].matches("[0-9]+"))||
				(dadosFuncionario[3].isEmpty())		 || (dadosFuncionario[3].length() < 10) || 
				(dadosFuncionario[3].length() > 11)  || (dadosFuncionario[4].isEmpty()) ||
			(!dadosFuncionario[4].matches("[0-9]+")) || (dadosFuncionario[4].length() != 11) || 
				(dadosFuncionario[5].isEmpty())      || (dadosFuncionario[6].isEmpty()) || 
			(dadosFuncionario[7].isEmpty())) { 
	...
	public boolean inserirEditarCliente(String[] dadosCliente) {
		if((dadosCliente[1].matches(".*\\d.*")) || (dadosCliente[1].isEmpty()) ||
				(!dadosCliente[2].contains("@")) ||	(dadosCliente[2].isEmpty())	||
				(dadosCliente[2].charAt(0)=='@') || (!dadosCliente[3].matches("[0-9]+"))||
				(dadosCliente[3].isEmpty())	|| (dadosCliente[3].length() < 10) || 
				(dadosCliente[3].length() > 11) ||  (dadosCliente[4].isEmpty())	||
				(!dadosCliente[4].matches("[0-9]+"))|| (dadosCliente[4].length() != 11) ||
				(dadosCliente[5].isEmpty())	|| (dadosCliente[6].isEmpty())	||
				(dadosCliente[3].isEmpty())	) {
				return false;
	...
	public boolean inserirEditarArmacao(String[] dadosArmacao) {
		if(dadosArmacao[1].isEmpty()|| dadosArmacao[2].isEmpty() || dadosArmacao[3].isEmpty() || 
				dadosArmacao[4].isEmpty() ||dadosArmacao[5].isEmpty()|| dadosArmacao[6].isEmpty() ||
				(!dadosArmacao[6].matches("[0.0-9.0]+")) || (!dadosArmacao[7].matches("[0-9]+"))|| dadosArmacao[7].isEmpty()) {
			return false;
		} else {
	...
	public boolean inserirEditarLente(String[] dadosLente) {
		if(dadosLente[1].isEmpty() || dadosLente[2].isEmpty()|| dadosLente[3].isEmpty() || 
				!dadosLente[3].matches("[0.0-9.0]+") || dadosLente[4].isEmpty() ||
				!dadosLente[5].matches("[0-9]+") || dadosLente[5].isEmpty()||
				!dadosLente[6].matches("[0-9]+") || dadosLente[1].isEmpty() ) {
			return false;
		} else {
	...
	public boolean inserirEditarLenteDeContato(String[] dadosContato) {
		if(dadosContato[1].isEmpty()|| dadosContato[2].isEmpty() || dadosContato[3].isEmpty()|| 
				dadosContato[4].isEmpty()|| dadosContato[5].isEmpty()|| !dadosContato[6].matches("[0-9]+") ||
				dadosContato[6].isEmpty()|| dadosContato[7].isEmpty() || !dadosContato[7].matches("[0.0-9.0]+")) {
			return false;
		} else {
	...
	public boolean inserirEditarDadosReceita(String[] dadosReceita) {
		if(dadosReceita[1].isEmpty() || dadosReceita[2].isEmpty() ||!dadosReceita[2].matches("[0-9]+") || 
				!dadosReceita[3].matches("[0-9]+") || dadosReceita[3].isEmpty() || dadosReceita[4].isEmpty() ||
				!dadosReceita[4].matches("[0-9]+") || dadosReceita[5].isEmpty() ) {
			return false;
		} else {
	...
	public boolean inserirEditarCompra(String[] dadosCompra) {
		if(dadosCompra[1].isEmpty() || dadosCompra[2].isEmpty() ||!dadosCompra[2].matches("[0-9]+") || 
				!dadosCompra[3].matches("[0-9]+") || dadosCompra[3].isEmpty() || dadosCompra[4].isEmpty() || 
				dadosCompra[5].isEmpty() || dadosCompra[6].isEmpty() || dadosCompra[7].isEmpty() || 
				!dadosCompra[8].matches("[0-9]+") || dadosCompra[8].isEmpty() || dadosCompra[9].isEmpty() ||
				!dadosCompra[9].matches("[0-9]+") || dadosCompra[10].isEmpty()) {
			return false;
		} else {
