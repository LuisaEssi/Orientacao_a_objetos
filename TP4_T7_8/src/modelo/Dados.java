...
public class Dados {
	...
	public void fillWithSomeData() {
		for(int i = 0; i < 3; i++) {
			clientes[i] = new Cliente("Cliente"+i,"luisa@gmail.com","4052856"+(i), "0000000000"+i,"Brasilia");
			funcionarios[i] = new Funcionario("Funcionário"+i,i+"func@gmail.com","5002898"+i, "0000000000"+i, "gerente", "8:00 às 14:00", "10.00");
			dadosReceita[i] = new DadosReceita(true,"2", "2","3"+i,"multifoca");
			armacao[i] = new Armacao("Masculino", "Azul", "Acetato","Esporte","Ray Ban", 100.00*i, 3*i);
			lente[i] = new Lente("Degradê", "Acrílico", 120.0*i, "Rosa", 145-(i*10), 10*i);	
			contato[i] = new LenteDeContato("Hidrogel"+i, "mensal"+i, "Acuvue"+i, "transparente", "Soro", 2*i, 100.00*0.5*i);
