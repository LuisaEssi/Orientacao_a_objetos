...
//		if(!dadosLente[3].matches("[0-9]+") || !dadosLente[4].matches("[0-9]+") || !dadosLente[6].matches("[0-9]+") ) {
//			return false;
//		} else {
...
//		String aux;
	...
	public boolean removerArmacao(int i) {
		...
		if(i == (d.getQtdarmacao() - 1)) { // O Armacao a ser removido est� no final do array
			d.setQtdarmacao(d.getQtdarmacao() - 1);
			d.getArmacao()[d.getQtdarmacao()] = null;
			return true;
		} else { // o Armacao a ser removido est� no meio do array
			int cont = 0;
	...
	public boolean removerLente(int i) {
		...
		if(i == (d.getQtdlente() - 1)) { // A Lente a ser removido est� no final do array
			d.setQtdlente(d.getQtdlente() - 1);
			d.getLente()[d.getQtdlente()] = null;
			return true;
		} else { // A Lente ser removido estano meio do array
			int cont = 0;
	...
	public boolean removerContato(int i) {
		...
		if(i == (d.getQtdcontato() - 1)) { // O Contato a ser removido est� no final do array
			d.setQtdcontato(d.getQtdcontato() - 1);
			d.getContato()[d.getQtdcontato()] = null;
			return true;
		} else { // o Contato a ser removido est� no meio do array
			int cont = 0;
