public class LenteDeContato {
	...
	private Estoque estoqueContato; 			//associacao
	private DadosReceita receita;				//associação
	
	//---------construtor----------
	
	public LenteDeContato(String materialDaLente, String tipoDeDescarte, String marca, String cor, String produtosDeHig) {
		//Estoque estoqueContato, DadosReceita receita
		super();
